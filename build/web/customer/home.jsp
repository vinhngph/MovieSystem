            ...
            <table border="1px">
                ...
                <c:forEach var="movie" items="${requestScope.MOVIES}">
                    <tr>
                        ...
                        <td>
                            <button type="submit" value="${movie.id}" name="movie_id">Choose</button>
                        </td>
                    </tr>
                </c:forEach>
            </table>
            ...
            <table border="1px">
                ...
                <c:forEach var="cinema" items="${requestScope.CINEMAS}">
                    <tr>
                        ...
                        <td>
                            <button type="submit" value="${cinema.id}" name="cinema_id">Choose</button>
                        </td>
                    </tr>
                </c:forEach>
            </table>
            ...
            <table border="1px">
                ...
                <c:forEach var="schedule" items="${requestScope.SCHEDULES}">
                    <tr>
                        ...
                        <td>
                            <button type="submit" value="${schedule.id}" name="schedule_id">Choose</button>
                        </td>
                    </tr>
                </c:forEach>
            </table>
